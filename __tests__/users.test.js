...
//    it('deve devolver un status 500 si se da un error interno',async ()=>{
//       const god_user = {
//          id: 1,
//          username: "siacobo0"
//      }
...
//      const stub = sinon.stub(models.users, 'findAll').throws(Error ('falla db'))
...
test('ya nose',async ()=>{ 
    ...
    const stub = sinon.stub(models.users, 'findAll').throws('500')
